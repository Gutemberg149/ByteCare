...
public class AnimalRequest {
    ...
    public Animal toEntity() {
        return Animal.builder()
                .nome(this.nome)
                .tipo(this.tipo != null ? this.tipo.name() : null)
                .raca(this.raca)              // Verifique se isso está aqui
                .dataNascimento(this.dataNascimento) // Verifique se isso está aqui
                .observacaoGeral(this.observacaoGeral) // Verifique se isso está aqui
                .ativo(this.ativo)           // Verifique se isso está aqui
                .build();
    }

    /**
     * Converte uma Entidade Animal para DTO.
     * Útil para retornar o request preenchido ao realizar edições.
     */
    public static AnimalRequest toDto(Animal animal) {
        if (animal == null) {
            return null;
